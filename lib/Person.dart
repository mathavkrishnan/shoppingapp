...
class _profileState extends State<profile> {
  ...
  static const List<String> opt = ["rin", "rin1", "rin2"];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.white,
      appBar: AppBar(
        title: Text("Profile detail",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black),),
              ...
              builder: (context,snapshot) {
                ...
                if(snapshot.hasData){
                  for(var i in items){
                    ...
                    final String mobileno = i.get('Mobileno');
                    final String address = i.get('Address');
                    final user = _auth.currentUser;
                    String newmob="",newaddress="";
                        ...
                        children: <Widget>[
                          ...
                          Center(
                            child: MaterialButton(
                              ...
                              color: Colors.black,
                              onPressed: () {
                                _firestore.collection('Users').where('Name', isEqualTo: authuser).get().then((querySnapshot) {
